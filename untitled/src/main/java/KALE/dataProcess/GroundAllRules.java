...
public class GroundAllRules {
    ...
    public void readData(String fnRelationIDMap,
        ...
        BufferedReader reader = new BufferedReader(new InputStreamReader(
                Files.newInputStream(Paths.get(fnRelationIDMap)), StandardCharsets.UTF_8));
        String line = "";
...
//			System.out.println(iRelationID+strRelation);
        ...
        if (!fnRules.equals("")) {
            reader = new BufferedReader(new InputStreamReader(
                    Files.newInputStream(Paths.get(fnRules)), StandardCharsets.UTF_8));
            int count =0;
            while ((line = reader.readLine()) != null) {
...
//		System.out.println(LstRuleTypeIII.size());
        ...
        reader = new BufferedReader(new InputStreamReader(
                Files.newInputStream(Paths.get(fnTrainingTriples)), StandardCharsets.UTF_8));
        while((line = reader.readLine()) != null) {
            String[] tokens = line.split("\t");
    ...
    public void groundRule(int iEntities,String fnOutput) throws Exception {
        ...
        BufferedWriter writer = new BufferedWriter(new OutputStreamWriter(
                Files.newOutputStream(Paths.get(fnOutput)), StandardCharsets.UTF_8));
...
//			Integer iSndRelation = LstRuleTypeII.get(iFstRelation);
    ...
    public static void main(String[] args) throws Exception {
        int iEntities = 14951;
        // Input file:
        String fnRelationIDMap = "D:\\Program Files\\JavaProject\\KALE\\untitled\\src\\main\\java\\KALE\\datasets\\wn18\\relationid.txt";
        String fnRules = "D:\\Program Files\\JavaProject\\KALE\\untitled\\src\\main\\java\\KALE\\datasets\\wn18\\wn18_rule";
        String fnTrainingTriples = "D:\\Program Files\\JavaProject\\KALE\\untitled\\src\\main\\java\\KALE\\datasets\\wn18\\train.txt";
        //Output file:
        String fnOutput = "D:\\Program Files\\JavaProject\\KALE\\untitled\\src\\main\\java\\KALE\\datasets\\wn18\\groundings2.txt";
